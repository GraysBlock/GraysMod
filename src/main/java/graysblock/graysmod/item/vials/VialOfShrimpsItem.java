...
public class VialOfShrimpsItem extends Item {

    public VialOfShrimpsItem(Settings settings) {
        super(settings);
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (!world.isClient) {
            ...
            user.addStatusEffect(new StatusEffectInstance(GraysModStatusEffects.SHRIMP_FORM, 3600, 0));
        }
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        ...
        List<StatusEffectInstance> list = List.of(new StatusEffectInstance(GraysModStatusEffects.SHRIMP_FORM, 3600, 0));
