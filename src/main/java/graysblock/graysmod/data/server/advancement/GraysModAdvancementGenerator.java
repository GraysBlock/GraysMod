...
public class GraysModAdvancementGenerator extends FabricAdvancementProvider {

    public GraysModAdvancementGenerator(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registryLookup) {
